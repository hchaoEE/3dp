...
if {[info exist ::env(TSV_DELAY)]} {
  source $::env(SCRIPTS_DIR)/3D_times.tcl
}

if {[info exist ::env(ONLY_WITH_MACRO)]} {
  load_design 2_floorplan.odb 2_floorplan.sdc "Starting CTS"
...
set json_file $::env(RESULTS_DIR)/4_1_cts.fp.json
