...
#clk
place_pin -pin_name clk -pin_size {0.44 1.28} -layer Bonding_layer -location {0 770}
...
foreach wd $writedata {
    ...
    place_pin -layer Bonding_layer -pin_size {0.44 1.28} -pin_name $wd -location $xy_list
}
close $writedata_loc
...
foreach da $dataadr {
    ...
    set y [lindex $x_y 1]
    set xy_list [list $x $y]
    place_pin -layer Bonding_layer -pin_size {0.44 1.28} -pin_name $da -location $xy_list
}
close $dataadr_loc
...
foreach id $inter_dmem {
    ...
    set y [lindex $x_y 1]
    set xy_list [list $x $y]
    place_pin -layer Bonding_layer -pin_size {0.44 1.28} -pin_name $id -location $xy_list
}
...
foreach em $e_mem {
    ...
    set y [lindex $x_y 1]
    set xy_list [list $x $y]
    place_pin -layer Bonding_layer -pin_size {0.44 1.28} -pin_name $em -location $xy_list
}
close $e_mem_loc
